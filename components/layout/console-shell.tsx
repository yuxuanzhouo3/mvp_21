...
export function ConsoleShell({
  ...
  return (
    <>
      <header className="sticky top-0 z-10 flex min-h-12 shrink-0 items-center gap-2 border-b border-border/70 bg-background/90 px-3 py-2 backdrop-blur md:h-16 md:px-6 md:py-0">
        <SidebarTrigger />
      ...
      <main className="flex-1 p-3 sm:p-4 md:p-6 lg:p-8">
        <section className="mb-4 flex flex-col gap-3 rounded-xl border border-border/70 bg-card/95 p-4 shadow-sm sm:gap-4 sm:rounded-2xl sm:p-5 md:mb-8 md:flex-row md:items-center md:justify-between md:p-6">
