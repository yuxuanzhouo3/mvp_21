  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Review the contract and add your signature</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">3 pages • Last updated Jan 10, 2025</p>
                  </div>
                </div>
              ...
              <div className="border border-border rounded-lg p-6 bg-muted/30 max-h-[500px] overflow-y-auto">
            ...
            <Card className="border-accent bg-accent/5">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-accent">Contract Signed Successfully</h3>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Signed on Jan 10, 2025</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
